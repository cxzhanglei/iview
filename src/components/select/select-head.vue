<template>
    <div @click="onHeaderClick" :class="headCls">
        ...
        </div><div class="sw-tag sw-tag-checked" v-if="maxTagCount !== undefined && selectedMultiple.length > maxTagCount">
            <span class="sw-tag-text sw-select-max-tag">
